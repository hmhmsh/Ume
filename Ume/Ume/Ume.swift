...
extension Ume {
	...
	public func string<T: RawRepresentable>(forKey defaultName: T) -> String? where T.RawValue == String {
		UserDefaults.standard.string(forKey: defaultName.rawValue)
	}
	
	/// -arrayForKey: is equivalent to -objectForKey:, except that it will return nil if the value is not an NSArray.
	public func array<T: RawRepresentable>(forKey defaultName: T) -> [Any]? where T.RawValue == String {
		UserDefaults.standard.array(forKey: defaultName.rawValue)
	}
	
	/// -dictionaryForKey: is equivalent to -objectForKey:, except that it will return nil if the value is not an NSDictionary.
	public func dictionary<T: RawRepresentable>(forKey defaultName: T) -> [String: Any]? where T.RawValue == String {
		UserDefaults.standard.dictionary(forKey: defaultName.rawValue)
	}
	
	/// -dataForKey: is equivalent to -objectForKey:, except that it will return nil if the value is not an NSData.
	public func data<T: RawRepresentable>(forKey defaultName: T) -> Data? where T.RawValue == String {
	...
	public func stringArray<T: RawRepresentable>(forKey defaultName: T) -> [String]? where T.RawValue == String {
	 ...
	 */
	public func integer<T: RawRepresentable>(forKey defaultName: T) -> Int where T.RawValue == String {
		UserDefaults.standard.integer(forKey: defaultName.rawValue)
	}
	
	/// -floatForKey: is similar to -integerForKey:, except that it returns a float, and boolean values will not be converted.
	public func float<T: RawRepresentable>(forKey defaultName: T) -> Float where T.RawValue == String {
	...
	public func double<T: RawRepresentable>(forKey defaultName: T) -> Double where T.RawValue == String {
	 ...
	 */
	public func bool<T: RawRepresentable>(forKey defaultName: T) -> Bool where T.RawValue == String {
	 ...
	 */
	@available(iOS 4.0, *)
	public func url<T: RawRepresentable>(forKey defaultName: T) -> URL? where T.RawValue == String {
...
extension Ume {
	 ...
	 */
	public func set<T: RawRepresentable>(_ value: Any?, forKey defaultName: T) where T.RawValue == String {
		UserDefaults.standard.set(value, forKey: defaultName.rawValue)
	}
	
	/// -setInteger:forKey: is equivalent to -setObject:forKey: except that the value is converted from an NSInteger to an NSNumber.
	public func set<T: RawRepresentable>(_ value: Int, forKey defaultName: T) where T.RawValue == String {
		UserDefaults.standard.set(value, forKey: defaultName.rawValue)
	}
	
	/// -setFloat:forKey: is equivalent to -setObject:forKey: except that the value is converted from a float to an NSNumber.
	public func set<T: RawRepresentable>(_ value: Float, forKey defaultName: T) where T.RawValue == String {
		UserDefaults.standard.set(value, forKey: defaultName.rawValue)
	}
	
	/// -setDouble:forKey: is equivalent to -setObject:forKey: except that the value is converted from a double to an NSNumber.
	public func set<T: RawRepresentable>(_ value: Double, forKey defaultName: T) where T.RawValue == String {
		UserDefaults.standard.set(value, forKey: defaultName.rawValue)
	}
	
	/// -setBool:forKey: is equivalent to -setObject:forKey: except that the value is converted from a BOOL to an NSNumber.
	public func set<T: RawRepresentable>(_ value: Bool, forKey defaultName: T) where T.RawValue == String {
		UserDefaults.standard.set(value, forKey: defaultName.rawValue)
	}
	...
	@available(iOS 4.0, *)
	public func set<T: RawRepresentable>(_ url: URL?, forKey defaultName: T) where T.RawValue == String {
...
extension Ume {
	...
	public func removeObject<T: RawRepresentable>(forKey defaultName: T) where T.RawValue == String {
